...
type Classification = {
  ...
  performanceQualifier?: Qualifier | null;
  capacityQualifier?: Qualifier | null;
};
...
export default function Home() {
  ...
  /*
   * Carrega filhos de um nó somente quando o usuário abre o nó.
   */
  ...
  function addManualClassification() {
    ...
    const classification: Classification = {
      ...
      source: "manual",
      performanceQualifier: selectedPerformance,
      capacityQualifier: selectedCapacity,
    };
  ...
  /*
   * Envia a descrição para a nossa API.
   *
  ...
  async function analyzeWithAI() {
    ...
    try {
      ...
      const response = await fetch("/api/icf/ai", {
        method: "POST",
        headers: {
   ...
   */
  function confirmAISuggestion(suggestion: AISuggestion) {
    const alreadyAdded = classifications.some(
      (item) => item.code === suggestion.code
    );
    ...
    const classification: Classification = {
      ...
      title: suggestion.title || suggestion.code,
      definition: suggestion.definition,
      source: "ai",
      reason: suggestion.reason,
      confidence: suggestion.confidence,
      performanceQualifier: null,
      capacityQualifier: null,
    };
  ...
  const canAddManual = useMemo(() => {
    ...
    return !classifications.some(
      (item) =>
        item.code === selectedEntity.entity.code
    );
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 max-w-3xl text-gray-600">
            Selecione categorias manualmente pela árvore
            oficial da CIF ou descreva o caso e receba
        ...
        <div className="mb-6 grid grid-cols-1 gap-3 md:grid-cols-2">
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-600">
              Descreva o funcionamento observado e receba
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-600">
              Navegue pela estrutura hierárquica oficial
              da CIF.
            </p>
          </button>
        </div>
        ...
        {mode === "ai" && (
          <section className="mb-8 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <div className="mb-5">
              ...
              <p className="mt-1 text-sm text-gray-600">
                Descreva de forma objetiva o funcionamento
                observado. A IA fará sugestões de categorias,
                não um diagnóstico.
              </p>
            </div>
            ...
            <div className="mt-2 text-sm text-gray-500">
              Quanto mais objetiva e funcional for a
              descrição, melhor será a qualidade das
              sugestões.
            </div>
            ...
            {aiSuggestions.length > 0 && (
              <div className="mt-8">
                <div className="mb-4">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    As categorias abaixo foram sugeridas pela
                    IA e validadas na base oficial da OMS.
                  </p>
                </div>
              ...
              <div className="mt-4 space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      Você descreve o funcionamento observado.
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      A IA identifica possíveis conceitos
                      funcionais presentes no texto.
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      São apresentados códigos candidatos, e
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      Os códigos sugeridos são consultados na
                      base oficial da CIF.
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      O profissional decide quais sugestões
                      realmente representam o caso.
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      Depois da confirmação, os qualificadores
                      podem ser definidos.
                    </div>
                  </div>
                </div>
          ...
          <section className="grid grid-cols-1 gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              <div className="mb-5">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  Navegue pela estrutura oficial e selecione
                  uma categoria.
                </p>
              </div>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <div className="flex min-h-[400px] items-center justify-center text-center">
                  <div>
                    ...
                    <p className="mt-1 max-w-sm text-sm text-gray-500">
                      Escolha uma categoria na árvore para ver
                      sua definição e seus qualificadores.
                    </p>
                  </div>
                </div>
              )}
              ...
              {selectedEntity && !loadingEntity && (
                <div>
                  ...
                  {/* QUALIFICADOR PERFORMANCE */}
                  {selectedEntity.qualifiers.performance
                    .length > 0 && (
                    <div className="mt-6">
                      <h3 className="font-bold text-gray-900">
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        Selecione o grau de dificuldade no
                        desempenho.
                      </p>

                      <div className="mt-3 space-y-2">
                        {selectedEntity.qualifiers.performance.map(
                          (qualifier) => (
                            <button
                              key={
                                qualifier.id ||
                  ...
                  {/* QUALIFICADOR CAPACITY */}
                  {selectedEntity.qualifiers.capacity
                    .length > 0 && (
                    <div className="mt-6">
                      <h3 className="font-bold text-gray-900">
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        Selecione o grau de dificuldade na
                        capacidade.
                      </p>

                      <div className="mt-3 space-y-2">
                        {selectedEntity.qualifiers.capacity.map(
                          (qualifier) => (
                            <button
                              key={
                                qualifier.id ||
        ...
        <section className="mt-8 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">
                Todas as categorias confirmadas, sejam
                adicionadas pela IA ou manualmente.
              </p>
            </div>
          ...
          {classifications.length === 0 ? (
            <div className="mt-5 rounded-xl border border-dashed border-gray-300 bg-gray-50 p-8 text-center text-sm text-gray-500">
              Nenhuma classificação adicionada ainda.
            </div>
          ) : (
                ...
                >
                  <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                    <div>
                      ...
                      {classification.performanceQualifier && (
                      ...
                      {classification.capacityQualifier && (
